...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('myapp', '0002_rename_user_usermodel'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='myapp.article', verbose_name='Стаття')),
            ],
            options={
